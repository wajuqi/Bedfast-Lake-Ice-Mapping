### This repository contains scripts for bedfast lake ice classification using Sentinel-1 imagery. A noval classification algorithm that combines both time series and threshold was used.
